# -*- coding: utf-8 -*-
"""
Created on Sat Nov  7 18:25:36 2020
...
df=pd.read_csv("F:/Intelligent Health/training.csv")
DF= pd.read_csv('F:/Intelligent Health/training.csv', index_col='prognosis')
...
tr=pd.read_csv("F:/Intelligent Health/testing.csv")
...
w2 = Label(root, justify=LEFT, text="How are you feeling today ?", fg="Green", bg="Ivory")
w2.config(font=("Times",30,"bold italic"))
w2.grid(row=0, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="Developer: Shahab Usaid\nResearcher: Rahim Shaikh\nTester: Maaz Sonde", fg="Green", bg="Ivory")
w2.config(font=("Times",8,"bold italic"))
w2.grid(row=0, column=3, pady=10, sticky=E)
w3 = Label(root, justify=LEFT, text="Version : 2.0 build 5", fg="black", bg="Ivory")
w3.config(font=("Times",10,"bold"))
w3.grid(row=23, column=3, pady=10, sticky=E)
...
root.iconbitmap('C:/Users/Asus/Downloads/cardiogram.ico')
root.mainloop()